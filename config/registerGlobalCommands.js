...
(async () => {
    try {
        console.log(` [Nicaina Music] :: Actualizando ${commands.length} application (/) commands globales.`.cyan);
        ...
        console.log(` [Nicaina Music] :: Recargados con éxito ${data.length} application (/) commands globales.`.green);
    } catch (error) {
